...
<div class="container-ms">
        ...
        <div class="center-content">
            <div id="Table_Output">
                <table class="w3-table w3-striped">
                    <tr>
                        <td>
                            <label style="color: #000; font-size: 18px; margin-right: 10px" for="Job_Name"><?php echo $text['job']; ?>:</label>
                            <div id="job_name_div" style=" display: contents; " onclick="document.getElementById('JobSelect').style.display='block'">
                                ...
                                <input style="height:35px; font-size:18px" type="text" id="Job_Name" name="Job_Name" size="20" maxlength="10" value="" disabled>
                            </div>
            ...
            <div id="JobSelect" class="modal">
                <form class="w3-modal-content w3-card-4 w3-animate-zoom" style="width: 400px; top:10%" action="">
                    <div class="container2 w3-light-grey">
                        ...
                        <table id="Job_Select" style="margin: 5px 10px 10px">
                            <tr>
                                <td>
                ...
                <table id="TableOutput" class="w3-table-all w3-hoverable w3-large" style=" width: 100%">
                    <thead>
                        <tr style="height:48px; font-size: 16px;" class="w3-dark-grey">
                            <th class="w3-center" width="15%"><?php echo $text['event']; ?></th>
                            <th class="w3-center" width="7.2%">1</th>
                            <th class="w3-center" width="7.2%">2</th>
                            <th class="w3-center" width="7.2%">3</th>
                            <th class="w3-center" width="7.2%">4</th>
                            <th class="w3-center" width="7.2%">5</th>
                            <th class="w3-center" width="7.2%">6</th>
                            <th class="w3-center" width="7.2%">7</th>
                            <th class="w3-center" width="7.2%">8</th>
                            <th class="w3-center" width="7.2%">9</th>
                            <th class="w3-center" width="10%"><?php echo $text['time']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
    ...
    <div id="OutputNew" class="modal">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="width: 650px; top: 15%">
            <header class="w3-container w3-dark-grey" style="height: 48px">
            ...
            <table id="OutputNew_Modal"class="w3-table w3-large">
                <tr>
                    <td>
                        <form id="Select_Event" action="#">
                            ...
                            <select id="event_select" style="margin: 0px 0px 20px" onchange="option_ini()">
                ...
                <tr>
                    <td>
                        ...
                        <input style="zoom:1.8;vertical-align: middle" id="output_1_signal01" name="Output_Option" value="1_01" type="radio" onclick="toggleOnputTime('Time1', this.checked,'1')">
                        <label for="output_1_signal01"><img src="../public/img/signal01.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_1_signal02" name="Output_Option" value="1_02" type="radio" onclick="toggleOnputTime('Time1', this.checked,'2')">
                        <label for="output_1_signal02"><img src="../public/img/signal02.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_1_trigger" name="Output_Option" value="1_03" type="radio" onclick="toggleOnputTime('Time1', this.checked,'3')">
                        <label for="output_1_trigger"><img class="bigger" src="../public/img/trigger_2.png" width="50" height="23"></label>
                        <input id="Time1" placeholder='ms' type='text' size="2" maxlength="4" value="" style="text-align: center; background-color: #DDDDDD; border-color: transparent; width:53px;" disabled>
                    </td>
                    <td>
                        <label for="Output6">6 :</label>
                        <input style="zoom:1.8; vertical-align: middle" id="output_6_signal01" name="Output_Option" value="6_01" type="radio" onclick="toggleOnputTime('Time6', this.checked,'1')">
                        <label for="output_6_signal01"><img src="../public/img/signal01.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_6_signal02" name="Output_Option" value="6_02" type="radio" onclick="toggleOnputTime('Time6', this.checked,'2')">
                        <label for="output_6_signal02"><img src="../public/img/signal02.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_6_trigger" name="Output_Option" value="6_03" type="radio" onclick="toggleOnputTime('Time6', this.checked,'3')">
                        <label for="output_6_trigger"><img src="../public/img/trigger_2.png" width="50" height="23"></label>
                        <input id="Time6" placeholder='ms' type='text' size="2" maxlength="4" value="" style="text-align: center; background-color: #DDDDDD; border-color: transparent; width:53px;" disabled>
                    </td>
                </tr>
                <tr>
                    <td>
                        <label for="Output2">2 :</label>
                        <input style="zoom:1.8; vertical-align: middle" id="output_2_signal01" name="Output_Option" value="2_01" type="radio" onclick="toggleOnputTime('Time2', this.checked,'1')">
                        <label for="output_2_signal01"><img src="../public/img/signal01.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_2_signal02" name="Output_Option" value="2_02" type="radio" onclick="toggleOnputTime('Time2', this.checked,'2')">
                        <label for="output_2_signal02"><img src="../public/img/signal02.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_2_trigger" name="Output_Option" value="2_03" type="radio" onclick="toggleOnputTime('Time2', this.checked,'3')">
                        <label for="output_2_trigger"><img src="../public/img/trigger_2.png" width="50" height="23"></label>
                        <input id="Time2" placeholder='ms' type='text' size="2" maxlength="4" value="" style="text-align: center; background-color: #DDDDDD; border-color: transparent; width:53px;" disabled>
                    </td>
                    <td>
                        <label for="Output7">7 :</label>
                        <input style="zoom:1.8; vertical-align: middle" id="output_7_signal01" name="Output_Option" value="7_01" type="radio" onclick="toggleOnputTime('Time7', this.checked,'1')">
                        <label for="output_7_signal01"><img src="../public/img/signal01.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_7_signal02" name="Output_Option" value="7_02" type="radio" onclick="toggleOnputTime('Time7', this.checked,'2')">
                        <label for="output_7_signal02"><img src="../public/img/signal02.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_7_trigger" name="Output_Option" value="7_03" type="radio" onclick="toggleOnputTime('Time7', this.checked,'3')">
                        <label for="output_7_trigger"><img src="../public/img/trigger_2.png" width="50" height="23"></label>
                        <input id="Time7" placeholder='ms' type='text' size="2" maxlength="4" value="" style="text-align: center; background-color: #DDDDDD; border-color: transparent; width:53px;" disabled>
                    </td>
                </tr>
                <tr>
                    <td>
                        <label for="Output3">3 :</label>
                        <input style="zoom:1.8; vertical-align: middle" id="output_3_signal01" name="Output_Option" value="3_01" type="radio" onclick="toggleOnputTime('Time3', this.checked,'1')">
                        <label for="output_3_signal01"><img src="../public/img/signal01.png" width="30" height="30" alt=""></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_3_signal02" name="Output_Option" value="3_02" type="radio" onclick="toggleOnputTime('Time3', this.checked,'2')">
                        <label for="output_3_signal02"><img src="../public/img/signal02.png" width="30" height="30" alt=""></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_3_trigger" name="Output_Option" value="3_03" type="radio" onclick="toggleOnputTime('Time3', this.checked,'3')">
                        <label for="output_3_trigger"><img src="../public/img/trigger_2.png" width="50" height="23" alt=""></label>
                        <input id="Time3" placeholder='ms' type='text' size="2" maxlength="4" value="" style="text-align: center; background-color: #DDDDDD; border-color: transparent; width:53px;" disabled>
                    </td>
                    <td>
                        <label for="Output8">8 :</label>
                        <input style="zoom:1.8; vertical-align: middle" id="output_8_signal01" name="Output_Option" value="8_01" type="radio" onclick="toggleOnputTime('Time8', this.checked,'1')">
                        <label for="output_8_signal01"><img src="../public/img/signal01.png" width="30" height="30" alt=""></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_8_signal02" name="Output_Option" value="8_02" type="radio" onclick="toggleOnputTime('Time8', this.checked,'2')">
                        <label for="output_8_signal02"><img src="../public/img/signal02.png" width="30" height="30" alt=""></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_8_trigger" name="Output_Option" value="8_03" type="radio" onclick="toggleOnputTime('Time8', this.checked,'3')">
                        <label for="output_8_trigger"><img src="../public/img/trigger_2.png" width="50" height="23" alt=""></label>
                        <input id="Time8" placeholder='ms' type='text' size="2" maxlength="4" value="" style="text-align: center; background-color: #DDDDDD; border-color: transparent; width:53px;" disabled>
                    </td>
                </tr>
                <tr>
                    <td>
                        <label for="Output4">4 :</label>
                        <input style="zoom:1.8; vertical-align: middle" id="output_4_signal01" name="Output_Option" value="4_01" type="radio" onclick="toggleOnputTime('Time4', this.checked,'1')">
                        <label for="output_4_signal01"><img src="../public/img/signal01.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_4_signal02" name="Output_Option" value="4_02" type="radio" onclick="toggleOnputTime('Time4', this.checked,'2')">
                        <label for="output_4_signal02"><img src="../public/img/signal02.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_4_trigger" name="Output_Option" value="4_03" type="radio" onclick="toggleOnputTime('Time4', this.checked,'3')">
                        <label for="output_4_trigger"><img src="../public/img/trigger_2.png" width="50" height="23"></label>
                        <input id="Time4" placeholder='ms' type='text' size="2" maxlength="4" value="" style="text-align: center; background-color: #DDDDDD; border-color: transparent; width:53px;" disabled>
                    </td>
                    <td>
                        <label for="Output9">9 :</label>
                        <input style="zoom:1.8; vertical-align: middle" id="output_9_signal01" name="Output_Option" value="9_01" type="radio" onclick="toggleOnputTime('Time9', this.checked,'1')">
                        <label for="output_9_signal01"><img src="../public/img/signal01.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_9_signal02" name="Output_Option" value="9_02" type="radio" onclick="toggleOnputTime('Time9', this.checked,'2')">
                        <label for="output_9_signal02"><img src="../public/img/signal02.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_9_trigger" name="Output_Option" value="9_03" type="radio" onclick="toggleOnputTime('Time9', this.checked,'3')">
                        <label for="output_9_trigger"><img src="../public/img/trigger_2.png" width="50" height="23"></label>
                        <input id="Time9" placeholder='ms' type='text' size="2" maxlength="4" value="" style="text-align: center; background-color: #DDDDDD; border-color: transparent; width:53px;" disabled>
                    </td>
                </tr>
                <tr>
                    <td>
                        <label for="Output5">5 :</label>
                        <input style="zoom:1.8; vertical-align: middle" id="output_5_signal01" name="Output_Option" value="5_01" type="radio" onclick="toggleOnputTime('Time5', this.checked,'1')">
                        <label for="output_5_signal01"><img src="../public/img/signal01.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_5_signal02" name="Output_Option" value="5_02" type="radio" onclick="toggleOnputTime('Time5', this.checked,'2')">
                        <label for="output_5_signal02"><img src="../public/img/signal02.png" width="30" height="30"></label>

                        <input style="zoom:1.8; vertical-align: middle" id="output_5_trigger" name="Output_Option" value="5_03" type="radio" onclick="toggleOnputTime('Time5', this.checked,'3')">
                        <label for="output_5_trigger"><img src="../public/img/trigger_2.png" width="50" height="23"></label>
                        <input id="Time5" placeholder='ms' type='text' size="2" maxlength="4" value="" style="text-align: center; background-color: #DDDDDD; border-color: transparent; width:53px;" disabled>
                    </td>
                    <td></td>
                </tr>
            </table>
        ...
        <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="width: 500px; top: 15%">
            <div class="container2 w3-light-grey">
                ...
                <div class="modal-body">
                    <form id="Copy_form">
                        <label for="from_job_id" class="col-sm-5 col-form-label"><?php echo $text['copy_from']; ?></label>
                        <div style="padding-left: 10px">
                            <div class="row mb-3">
                                <label for="from_job_id" class="col-sm-5 col-form-label"><?php echo $text['job_id']; ?> :</label>
                                <div class="col-sm-5">
                                    <input type="number" class="form-control" id="from_job_id" disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="from_job_name" class="col-sm-5 col-form-label"><?php echo $text['job_name']; ?> :</label>
                                <div class="col-sm-5">
                        ...
                        <label for="from_job_id" class="col-sm-5 col-form-label"><?php echo $text['copy_to']; ?> </label>
                        <div style="padding-left: 10px;">
                            <label for="from_job_id" class="col-sm-5 col-form-label">Job :</label> &nbsp;
