        ...
        <div class="center-content">
            <div id="TableJobName">
                <table class="w3-table w3-striped">
                    <tr>
                        <td>
                            <label style="color: #000; margin-left: 3%; font-size:18px" for="job_id"><?php echo $text['job_id']; ?></label>
        	...
        	<div id="TableSeqSetting" align="center">
        	    <div class="scrollbar table-container" id="style-seq">
                		...
                		<table id="Table_Seq" class="w3-table-all w3-hoverable w3-large" style="margin: 0 !important;">
                			<thead id="header-table">
                				<tr style="height:45px; font-size: 3.4vmin" class="w3-dark-grey">
                	                ...
                	                <th class="w3-center" width="20%">Name</th>
                				...
                				<?php
                					foreach ($data['sequences'] as $key => $value) { //sequences列表
                			            ...
                			            echo '<td class="w3-center">
                			                    <button class="button_sequence" style="border:1px solid black;width:30px; height:30px;padding:0;background: url(../public/img/btn_plus.png) no-repeat;" id="button_sequence" type="button" onclick="edit_step(\''.$value['sequence_id'].'\');"></button>
                			                </td>';
    ...
    <div class="footer">
       	<div id="TotalPage">
            <table id="TotalSeqTable">
                <tr>
                    <td style="color:#000; float: left"><?php echo $text['total_seq']; ?> : <input style="text-align: center" id="RecordCnt" name="RecordCnt" readonly="readonly" disabled size="2" maxlength="2" value=""> </td>
                    <!--
	            ...
	            <div class="modal-body">
	                <form id="new_seq_form">
			            ...
			            <div class="row">
			                ...
			                <div class="col-2"  style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['Second']; ?></div>
			            </div>
			        </form>
	            </div>
