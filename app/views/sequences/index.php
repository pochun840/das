                		...
                		<table id="Table_Seq" class="w3-table-all w3-hoverable w3-large" style="margin: 0 !important;">
                			<thead id="header-table">
                				<tr style="height:48px; font-size: 16px;" class="w3-dark-grey">
                	                ...
                	                <th class="w3-center" width="25%"><?php echo $text['seq_name']; ?></th>
                	                <th class="w3-center" width="22%"><?php echo $text['target_type']; ?></th>
                				...
                				<?php
                					foreach ($data['sequences'] as $key => $value) { //sequences列表
                                		...
                                		echo '<td class="w3-center">
                                			<button class="w3-grey button_sequence" style="padding: 0;width:30px;height:30px;font-size: 18px;background: url(../public/img/btn_edit.png) no-repeat;" id="button_sequence" type="button" onclick="edit_step(\''.$value['sequence_id'].'\');"></button>
                			                </td>';
                						echo '</tr>';
                					}
                				?>
	  ...
	  <div class="modal-dialog modal-dialog-centered">
	    <div class="modal-content w3-animate-zoom" style="width: 550px">
	        <div class="modal-header">
	            ...
	            <button align="right" type="button" class="btn-close w3-hover-dark-gray:hover" data-bs-dismiss="modal" aria-label="Close"></button>
	        </div>
