...
<div class="container-ms">
    	<div class="w3-text-white w3-center">
    	    <header id="header">
                <h3><?php echo $text['normal_seq_management']; ?></h3>
    	    </header>
        </div>
        ...
        <div class="center-content">
            <div id="TableJobName">
                <table class="w3-table w3-striped">
                    <tr>
                        <td>
                            <label style="color: #000; margin-left: 3%; font-size:18px; margin: 3px" for="job_id"><?php echo $text['job_id']; ?></label>
                            <input style="height:33px; font-size:18px;text-align: center;margin: 3px" type="text" id="job_id" name="job_id" size="10" maxlength="20" value="<?php echo $data['job_id'];?>" disabled>
                        </td>
                        <td>
                            <button id="return" onclick="location.href = '?url=Jobs/index/'"><?php echo $text['return']; ?></button>
                        </td>
                    </tr>
                </table>
            </div>
                				...
                				<?php
                					foreach ($data['sequences'] as $key => $value) { //sequences列表
                						...
                						if($value['sequence_enable'] == 0){
                							echo '<td class="w3-center"><input class="seq_enable" style="zoom:1.8; vertical-align: middle" id="" name="" value="" type="checkbox" ></td>';
                						}else{
                							echo '<td class="w3-center"><input class="seq_enable" style="zoom:1.8; vertical-align: middle" id="" name="" value="" type="checkbox" checked="checked"></td>';
                						}
                                		...
                                		echo '<td class="w3-center">
                                			<button class="w3-grey button_sequence" style="border: 1px solid black;padding: 0;width:30px;height:30px;font-size: 18px;background: url(../public/img/btn_edit.png) no-repeat;" id="button_sequence" type="button" onclick="edit_step(\''.$value['sequence_id'].'\');"></button>
                			                </td>';
                						echo '</tr>';
                					}
                				?>
    ...
    <div class="footer">
    	<div id="TotalPage">
            <table id="TotalSeqTable">
                <tr>
                    <td style="color:#000; float: left"><?php echo $text['total_seq']; ?> : <input style="text-align: center" id="RecordCnt" name="RecordCnt" readonly="readonly" disabled size="5" maxlength="3" value=""> </td>
                    <!--
                    ...
                    <td>
                        <input style="text-align: center" id="Total_Seq" name="Total_Seq" readonly="readonly" disabled size="3" maxlength="3" value="" hidden>
                    </td>
                    -->
                </tr>
            </table>
	        ...
	        <div class="modal-content w3-animate-zoom" style="width: 550px">
	            ...
	            <div class="modal-body">
	                <form id="new_seq_form">
	                    <div class="row">
			                <div for="sequence_id" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['seq_id']; ?>：</div>
			                <div class="col" style="font-size: 18px; margin: 5px 0px 5px">
			                    <input type="number" class="form-control" id="sequence_id" disabled>
			                </div>
			            </div>
            			<div class="row">
            			    <div for="sequence_name" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['seq_name']; ?>：</div>
            			    <div class="col" style="font-size: 18px; margin: 5px 0px 5px">
			            ...
			            <div class="row">
			                <div for="TR" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['tightening_repeat']; ?>：</div>
			                <div class="col" style="font-size: 18px; margin: 5px 0px 5px">
			            ...
			            <div class="row">
			                <div for="ng_stop" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['NG_Stop']; ?>：</div>
			                <div class="col" style="font-size: 18px; margin: 5px 0px 5px">
			            ...
			            <div class="row">
			                <div for="ok_job" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['OK_Sequence']; ?>：</div>
			                <div class="col" style="font-size: 18px; margin: 5px 0px 5px">
			    	            <div class="form-check form-check-inline">
					                <input class="form-check-input" type="radio" name="ok_seq_option" id="ok_seq_off" value="0" style="zoom:1.3; vertical-align: middle">
					                <label class="form-check-label" for="ok_seq_off" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['switch_off']; ?></label>
					            </div>
			      	            <div class="form-check form-check-inline">
					                <input class="form-check-input" type="radio" name="ok_seq_option" id="ok_seq_on" value="1" style="zoom:1.3; vertical-align: middle">
					                <label class="form-check-label" for="ok_seq_on" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['switch_on']; ?></label>
					            </div>
			                </div>
			            </div>
        			    <div class="row">
        			        <div  class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['OK_Sequence_Stop']; ?>：</div>
        			        <div class="col" style="font-size: 18px; margin: 5px 0px 5px">
        			    	    <div class="form-check form-check-inline">
        					        <input class="form-check-input" type="radio" name="ok_seq_stop_option" id="ok_seq_stop_off" value="0" style="zoom:1.3; vertical-align: middle">
        					        <label class="form-check-label" for="ok_seq_stop_off" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['switch_off']; ?></label>
        					    </div>
        			      	    <div class="form-check form-check-inline">
        					        <input class="form-check-input" type="radio" name="ok_seq_stop_option" id="ok_seq_stop_on" value="1" style="zoom:1.3; vertical-align: middle">
        					        <label class="form-check-label" for="ok_seq_stop_on" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['switch_on']; ?></label>
        					    </div>
        			        </div>
        			    </div>
			            <div class="row">
			                <div for="timeout" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['Timeout']; ?>：</div>
			                <div class="col" style="font-size: 18px; margin: 5px 0px 5px">
			                ...
			                <div class="col"  style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['Second']; ?></div>
			            </div>
			        </form>
	            </div>
	        ...
	        <div class="modal-content w3-animate-zoom" style="width: 550px">
	            ...
	            <div class="modal-body">
	                <form id="copy_seq_form">
	                    <div for="from_seq_id" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['copy_from']; ?></div>
	                    <div style="padding-left: 10px;">
		                    <div class="row">
            				    <div for="from_seq_id" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['seq_id']; ?>：</div>
            				    <div class="col" style="font-size: 18px; margin: 5px 0px 5px">
               				        <input type="number" class="form-control" id="from_seq_id" disabled>
            				    </div>
        				    </div>
    				        <div class="row">
            				    <div for="from_seq_name" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['seq_name']; ?>：</div>
            				    <div class="col" style="font-size: 18px; margin: 5px 0px 5px">
			            ...
			            <div for="to_seq_id" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['copy_to']; ?></div>
			            <div style="padding-left: 10px;">
				            <div class="row">
				            <div for="to_seq_id" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['seq_id']; ?>：</div>
            				    <div class="col" style="font-size: 18px; margin: 5px 0px 5px">
            				        <input type="number" class="form-control" id="to_seq_id" disabled>
            				    </div>
				            </div>
				            <div class="row">
            				    <div for="to_seq_name" class="col-5" style="font-size: 18px; margin: 5px 0px 5px"><?php echo $text['seq_name']; ?>：</div>
            				    <div class="col" style="font-size: 18px; margin: 5px 0px 5px">
