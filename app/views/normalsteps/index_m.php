        ...
        <div class="center-content">
            <div class="container">
                <div style="margin: 3px;">
                    <label for="job_id" style="height:30px; font-size:18px; color: #000"><?php echo $text['job_id']; ?> : </label>
                	<input style="height:35px; font-size:18px;text-align: center; background-color: #F2F1F1" type="text" id="job_id" name="job_id" size="20" maxlength="20" value="<?php echo $data['job_id'];?>" disabled>
                </div>
                <div class="w3-center" style="margin-bottom: 5px">
                    <button id="bnt1" name="Torque_Display" class="button" style="margin: 3px;" onclick="FunctionKey('Torque')"><?php echo $text['torque']; ?></button>
                    <button id="bnt2" name="Angle_Display" class="button" style="margin: 3px;" onclick="FunctionKey('Angle')"><?php echo $text['angle']; ?></button>
                    <button id="return" style="margin: 5px;" onclick="history.go(-1);"><?php echo $text['return']; ?></button>
                </div>
            </div>
                        ...
                        <div class="force-overflow">
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td width="40%">
                                        <input style="font-size:15px; height:30px" class="form-control" id="Tool_Max_Torque" name="Tool_Max_Torque" size="5" value="<?php echo $data['tool_info']['tool_maxtorque'];?>" disabled> <?php echo $text['unit_status_'.$data['controller_Info']['device_torque_unit'].'']; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="font-size:15px; height:30px" class="form-control" id="Target_Torque"  name="Target_Torque" size="5" type="text" pattern="\d*" maxlength="6" value="<?php echo $data['noramlstep']['step_targettorque'];?>"> <?php echo $text['unit_status_'.$data['controller_Info']['device_torque_unit'].'']; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="font-size:15px; height:30px" class="form-control" id="Run_Down_Speed"  name="Run_Down_Speed" size="5" value="<?php echo $data['noramlstep']['step_rpm'];?>" type="text" pattern="\d*" maxlength="4" >
                                        <label style="font-size:14px" for="tool_maxrpm"><?php echo $text['max_rpm'];?> <?php echo $data['tool_info']['tool_maxrpm'];?></label>
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td width="40%">
                                        <input style="zoom:1.5; vertical-align: middle" type="radio" id="Downshift_Enable_OFF" name="Downshift_Enable" value="0">
                                        <label for="Downshift_Enable_OFF"><?php echo $text['switch_off']; ?></label>&nbsp;&nbsp;

                                        <input style="zoom:1.5; vertical-align: middle" type="radio" id="Downshift_Enable_ON" name="Downshift_Enable" value="1">
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td width="40%">
                                        <input style="zoom:1.5; margin:2px; vertical-align: middle" type="radio" id="Monitoring_Angle_OFF" name="Monitoring_Angle" value="0">
                                        <label for="Monitoring_Angle_OFF"><?php echo $text['switch_off']; ?></label>&nbsp;&nbsp;

                                        <input style="zoom:1.5; vertical-align: middle" type="radio" id="Monitoring_Angle_ON" name="Monitoring_Angle" value="1">
                                ...
                                <tr id="Monitoring_Angle_row1">
                                    ...
                                    <td>
                                        <input style="zoom:1.5; margin:2px; vertical-align: middle" type="radio" id="Over_Angle_Stop_OFF" name="Over_Angle_Stop" value="0">
                                        <label for="Over_Angle_Stop_OFF"><?php echo $text['switch_off']; ?></label>&nbsp;&nbsp;

                                        <input style="zoom:1.5; vertical-align: middle" type="radio" id="Over_Angle_Stop_ON" name="Over_Angle_Stop" value="1">
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td width="40%">
                                        <input style="zoom:1.5; margin:2px; vertical-align: middle" type="radio" id="Pre_Run_Unfasten_OFF" name="Pre_Run_Unfasten" value="0">
                                        <label for="Pre_Run_Unfasten_OFF"><?php echo $text['switch_off']; ?></label>&nbsp;&nbsp;

                                        <input style="zoom:1.5; vertical-align: middle" type="radio" id="Pre_Run_Unfasten_ON" name="Pre_Run_Unfasten" value="1">
                        ...
                        <div class="force-overflow">
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td width="40%">
                                        <input style="font-size:15px; height:30px" class="form-control" id="Tool_Max_Torque_A" name="Tool_Max_Torque_A" size="5" value="<?php echo $data['tool_info']['tool_maxtorque'];?>" disabled> <?php echo $text['unit_status_'.$data['controller_Info']['device_torque_unit'].'']; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="font-size:15px; height:30px" class="form-control" id="Run_Down_Speed_A"  name="Run_Down_Speed_A" size="5" value="<?php echo $data['noramlstep']['step_rpm'];?>" type="text" pattern="\d*" maxlength="4">
                                        <label style="font-size:14px" for="tool_maxrpm"><?php echo $text['max_rpm'];?> <?php echo $data['tool_info']['tool_maxrpm'];?></label>
                                        <div class="invalid-feedback"><?php echo $error_message['Run_Down_Speed']; ?></div>
                                    </td>
                                </tr>
                                ...
                                <tr id="tr_threshold_angle_A">
                                    ...
                                    <td>
                                        ...
                                        <div class="invalid-feedback"><?php echo $error_message['Threshold_Angle_A']; ?><span id=""></span></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="font-size:15px; height:30px" class="form-control" id="Hi_Torque_A"  name="Hi_Torque_A" size="5" value="<?php echo $data['noramlstep']['step_hightorque'];?>" type="text" pattern="\d*" maxlength="6"> <?php echo $text['unit_status_'.$data['controller_Info']['device_torque_unit'].'']; ?>
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td width="40%">
                                        <input style="zoom:1.5; margin:2px; vertical-align: middle" type="radio" id="Downshift_Enable_A_OFF" name="Downshift_Enable_A" value="0">
                                        <label for="Downshift_Enable_A_OFF"><?php echo $text['switch_off']; ?></label>&nbsp;&nbsp;

                                        <input style="zoom:1.5; vertical-align: middle" type="radio" id="Downshift_Enable_A_ON" name="Downshift_Enable_A" value="1">
                                ...
                                <tr id="Downshift_Enable_A_row1">
                                    ...
                                    <td>
                                        ...
                                        <div class="invalid-feedback"><?php echo $error_message['Downshift_Torque']; ?></div>
                                    </td>
                                </tr>
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td width="40%">
                                        <input style="zoom:1.5; margin:2px; vertical-align: middle" type="radio" id="Pre_Run_Unfasten_A_OFF" name="Pre_Run_Unfasten_A" value="0">
                                        <label for="Pre_Run_Unfasten_A_OFF"><?php echo $text['switch_off']; ?></label>&nbsp;&nbsp;

                                        <input style="zoom:1.5; vertical-align: middle" type="radio" id="Pre_Run_Unfasten_A_ON" name="Pre_Run_Unfasten_A" value="1">
            ...
            <div class="footer">
                <div id="buttonContainer" class="w3-center">
                    <button id="button1" class="button button3" onclick="save_step();"><?php echo $text['save']; ?></button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function form_normalstep_validate(target_type) {   
        ...
        if(target_type == 'angle'){
            ...
            document.getElementById('LA_range').textContent = '0 - ' + (Target_Angle_A_value-1);
