...
<div class="container-ms">
    <div class="w3-text-white w3-center">
        <table>
            <tr id="header">
                <td width="100%">
                    <h3 style="font-size: 24px"><?php echo $text['operation_result']; ?></h3>
                </td>
                <td>
    ...
    <div class="w3-display-container panel-container">
        <div class="w3-display-topleft p1">
        ...
        <div class="w3-display-topright p2" style="">
        ...
        <div id="p3" class="p3" style="">
            ...
            <span class="btn i-btn" style="position: absolute;right: 0;display: none;" onclick="test();"><i class="fa fa-info-circle" style="font-size: 24px;"></i></span>
        ...
        <div class="p4" style="">
            ...
            <div id="Message" class="w3-display-middle message-font" style="font-size: 3.5vmax;width: 100%;text-align: center; line-height: 1.2;top: 60%;">-</div>
        </div>

        <div id="graph" class="row p5" style="">
            <div class="col-lg-12" style="padding: 0;">
                <div id="chart" style="background-color:white"></div>
            </div>
        </div>

        <div class="p6 w3-center">
            <ul class="nav nav-pills" id="graphTab" role="tablist">
                <li class="nav-item" style="background-color: grey;border-radius: 0.25rem;margin-right: 5px;">
                    <a class="nav-link active" style="color: white; text-align: left"  href="#" onclick="G_type(1)"><?php echo $text['torque'].' '.$text['time']; ?></a>
                </li>
                <li class="nav-item" style="background-color: grey;border-radius: 0.25rem;margin-right: 5px;">
                    <a class="nav-link" style="color: white;" href="#" onclick="G_type(2)"><?php echo $text['angle'].' '.$text['time']; ?></a>
                </li>
                <li class="nav-item" style="background-color: grey;border-radius: 0.25rem;margin-right: 5px;">
                    <a class="nav-link" style="color: white;;" href="#" onclick="G_type(3)"><?php echo $text['rpm'].' '.$text['time']; ?></a>
                </li>
                <li class="nav-item" style="background-color: grey;border-radius: 0.25rem;">
                    <a class="nav-link" style="color: white;" href="#" onclick="G_type(4)"><?php echo $text['torque'].' '.$text['angle']; ?></a>
                </li>
            </ul>
        </div>
    </div>
            ...
            $.ajax({
              ...
              success: function(response) {
                ...
                if (response.updated || firsttime) {
                  ...
                  draw(data.system_sn);
                  $('#graphTab a:first').tab('show');//active ul first
                  //因應torque_unit調整介面文字
...
function draw(sn = 0) {
    ...
    var clientHeight = document.getElementById('graph').clientHeight;
...
function test(argument) {
    ...
    Swal.fire({
      title: '<?php echo $text['final_message']; ?>',
      text: message,
    })
