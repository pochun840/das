...
<div class="container.ms">
    ...
    <div class="main-content">
        <div class="center-content">
                ...
                <table class="w3-table w3-striped">
                    <tr>
                        <td>
                            ...
                            <input type="text" id="job_id" name="job_id" size="15" maxlength="20" value="<?php echo $data['job_id'];?>" disabled "disabled"
                        ...
                        <td>
                            ...
                            <input type="text" id="seq_id" name="seq_id" size="15" maxlength="20" value="<?php echo $data['sequence_id'];?>" disabled
                                style="height:35px; font-size:18px;text-align: center; background-color: #DDDDDD; border:0; margin: 3px;">
                        </td>
                        <td>
            ...
            <div id="TableStepSetting" align="center">
        	    <div class="scrollbar-step" id="style-step">
                    <div class="force-overflow-step">
        ...
        <div id="TotalPage">
            <table id="TotalStepTable">
                <tr>
                   ...
                   <!--
                   <td width="50%" align="right" style="color:black;display: none;">
    ...
    <div class="w3-modal" id="StepModal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="StepModalLabel" aria-hidden="true">
        <div class="w3-modal-content w3-animate-zoom w3-light-grey" style="width:550px">
            <header class="w3-container w3-dark-grey ">
                <span onclick="document.getElementById('StepModal').style.display='none'"
                    class="w3-button w3-red w3-xlarge w3-display-topright" style="margin: 2px; color: #000;">&times;</span>
                <h3 id="modal_title" style="line-height: inherit; text-align: left ">New Step</h3>
            </header>
            <div class="w3-bar w3-border-bottom w3-light-grey" style="padding: 2px">
                <table class="w3-bar-item">
                    <tr>
                        <td>
                            <label  style="color: #000" for="Job_ID_div"><?php echo $text['job_id']; ?>:</label>
                            <input type="text" id="Job_ID_div" name="Job_ID_div" size="10" maxlength="10" value="<?php echo $data['job_id'];?>" disabled>
                        </td>
                    </tr>
                </table>
                <button style="height: 45px; width: 80px; border-radius: 5px; font-size:16px;" class="tablink w3-bar-item w3-hover-blue" id="torque_button" onclick="OpenTarget(event, 'Torque')"><?php echo $text['torque']; ?></button>
                <button style="height: 45px; width: 80px; border-radius: 5px; font-size:16px" class="tablink w3-bar-item w3-hover-blue" id="angle_button" onclick="OpenTarget(event, 'Angle')"><?php echo $text['angle']; ?></button>
                <button style="height: 45px; width: 80px; border-radius: 5px; font-size:16px; display: none;"  class="tablink w3-bar-item w3-hover-blue" id="time_button" onclick="OpenTarget(event, 'Time')"><?php echo $text['time']; ?></button>
            </div>

            <div id="Torque" class="target" style="padding-left: 10px">
                        ...
                        <form id="new_step_target_torque">
                            <table id="Target_Torque_Table" class="w3-large">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Step_ID_Torque" name="Step_ID_Torque" size="5" disabled>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="zoom:1.8; vertical-align: middle" id="Direction_CW_T" name="Direction_Option_T" value="0" type="radio">
                                        <label for="Direction_CW_T"><?php echo $text['CW']; ?></label>
                                    </td>
                                    <td style="text-align: left;">
                                        <input style="zoom:1.8; vertical-align: middle" id="Direction_CCW_T" name="Direction_Option_T" value="1" type="radio">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="RPM" name="RPM" size="5"> <?php echo $text['max_rpm'];?> <?php echo $data['tool_info']['tool_maxrpm'];?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Delay_Time_T" name="Delay_Time_T" size="5">
                                ...
                                <tr>
                                   ...
                                   <td colspan="2">
                                        <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Target_Torque" name="Target_Torque" size="5"> <?php echo $text['unit_status_'.$data['controller_Info']['device_torque_unit'].'']; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="zoom:1.8; vertical-align: middle" id="Monitor_Window" name="Monitor_Option" value="0" type="radio">
                                        <label for="Monitor_Window"><?php echo $text['Window']; ?></label>
                                    </td>
                                    <td style="text-align: left;">
                                        <input style="zoom:1.8; vertical-align: middle" id="Monitor_HiLow" name="Monitor_Option" value="1" type="radio">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="zoom:1.8; vertical-align: middle" id="Monitor_Angle_OFF" name="Monitor_Angle_Option" value="0" type="radio">
                                        <label for="Monitor_Angle_OFF"><?php echo $text['switch_off']; ?></label>
                                    </td>
                                    <td style="text-align: left;">
                                        <input style="zoom:1.8; vertical-align: middle" id="Monitor_Angle_ON" name="Monitor_Angle_Option" value="1" type="radio">
                                ...
                                <tr id="Over_Ang_Stop_tr">
                                    ...
                                    <td>
                                        <input style="zoom:1.8; vertical-align: middle" id="Over_Ang_Stop_OFF" name="Over_Ang_Stop_Option" value="0" type="radio">
                                        <label for="Over_Ang_Stop_OFF"><?php echo $text['switch_off']; ?></label>
                                    </td>
                                    <td style="text-align: left;">
                                        <input style="zoom:1.8; vertical-align: middle" id="Over_Ang_Stop_ON" name="Over_Ang_Stop_Option" value="1" type="radio">
                                ...
                                <tr id="Torque_Window_tr">
                                    ...
                                    <td colspan="2">
                                        <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Torque_Window_Add" name="Torque_Window_Add" size="5" disabled>
                                        <label>&#43;&#8725;&#8722;</label>
                                        <input style="font-size:16px; height:25px" class="form-control" id="Torque_Window_Subtraction" name="Torque_Window_Subtraction" size="5">
                                ...
                                <tr id="Angle_Window_tr">
                                    ...
                                    <td colspan="2">
                                        <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Angle_Window_Add" name="Angle_Window_Add" size="5">
                                        <label>&#43;&#8725;&#8722;</label>
                                        <input style="font-size:16px; height:25px" class="form-control" id="Angle_Window_Subtraction" name="Angle_Window_Subtraction" size="5">
                                ...
                                <tr id="Hi_Torque_tr">
                                    ...
                                    <td colspan="2">
                                        <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Hi_Torque" name="Hi_Torque" size="5">
                                ...
                                <tr id="Lo_Torque_tr">
                                    ...
                                    <td colspan="2">
                                        <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Lo_Torque" name="Lo_Torque" size="5">
                                ...
                                <tr id="Hi_Angle_tr">
                                    ...
                                    <td colspan="2">
                                        <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Hi_Angle" name="Hi_Angle" size="5">
                                ...
                                <tr id="Lo_Angle_tr">
                                    ...
                                    <td colspan="2">
                                        <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Lo_Angle" name="Lo_Angle" size="5">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <select id="angle_mode_T" name="angle_mode_T" style="width: 100px; vertical-align: middle; margin:5px; text-align: left;">
            ...
            <div id="Angle" class="w3-container target">
                <table  id="Targer_Angle_Table" class="w3-large">
                    <tr>
                        <td width= "50%">
                            <label for=""><?php echo $text['seq_id']; ?> :</label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Step_ID_Angle" name="Step_ID_Angle" size="5" disabled>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input style="zoom:1.8; vertical-align: middle" id="Direction_CW_A" name="Direction_Option_A" value="0" type="radio">
                            <label for="Direction_CW_A"><?php echo $text['CW']; ?></label>
                        </td>
                        <td style="text-align: left;">
                            <input style="zoom:1.8; vertical-align: middle" id="Direction_CCW_A" name="Direction_Option_A" value="1" type="radio">
                    ...
                    <tr>
                        ...
                        <td>
                            <input style="zoom:1.8; vertical-align: middle" id="Monitor_Window_A" name="Monitor_Option_A" value="0" type="radio">
                            <label for="Monitor_Window_A"><?php echo $text['Window']; ?></label>
                        </td>
                        <td style="text-align: left;">
                            <input style="zoom:1.8; vertical-align: middle" id="Monitor_HiLow_A" name="Monitor_Option_A" value="1" type="radio">
                    ...
                    <tr id="Torque_Window_A_tr">
                        ...
                        <td colspan="2">
                            <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Torque_Window_Add_A" name="Torque_Window_Add_A" size="5">
                            <label>&#43;&#8725;&#8722;</label>
                            <input style="font-size:16px; height:25px" class="form-control" id="Torque_Window_Subtraction_A" name="Torque_Window_Subtraction_A" size="5">
                            <div class="invalid-feedback"><?php echo $error_message['Torque_Window_Add']; ?></div>
                            <div class="invalid-feedback delta_alert"><?php echo $error_message['Torque_Window_Subtraction'].' '.$data['delta']; ?></div>
                        </td>
                    </tr>
                    <tr id="Angle_Window_A_tr">
                        ...
                        <td colspan="2">
                            <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Angle_Window_Add_A" name="Angle_Window_Add_A" size="5" disabled>
                            <label>&#43;&#8725;&#8722;</label>
                            <input style="font-size:16px; height:25px" class="form-control" id="Angle_Window_Subtraction_A" name="Angle_Window_Subtraction_A" size="5">
                            <div class="invalid-feedback"><?php echo $error_message['Angle_Window_Add']; ?></div>
                        </td>
                    </tr>
                        <tr id="Hi_Torque_A_tr">
                            ...
                            <td colspan="2">
                                <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Hi_Torque_A" name="Hi_Torque_A" size="5">
                        ...
                        <tr id="Lo_Torque_A_tr">
                            ...
                            <td colspan="2">
                                <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Lo_Torque_A" name="Lo_Torque_A" size="5">
                        ...
                        <tr id="Hi_Angle_A_tr">
                            ...
                            <td colspan="2">
                                <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Hi_Angle_A" name="Hi_Angle_A" size="5">
                                <div class="invalid-feedback"><?php echo $error_message['High_Angle']; ?><span id="HA_range"></span></div>
                            </td>
                        </tr>
                        <tr id="Lo_Angle_A_tr">
                            ...
                            <td colspan="2">
                                <input style="font-size:16px; height:25px; margin:5px" class="form-control" id="Lo_Angle_A" name="Lo_Angle_A" size="5">
                                <div class="invalid-feedback"><?php echo $error_message['Low_Angle']; ?><span id="LA_range"></span></div>
                            </td>
                        </tr>
                        <tr>
    ...
    <div class="modal fade" id="CopySeq" data-bs-keyboard="false" tabindex="-1" aria-labelledby="CopySeqLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content w3-animate-zoom" style="width: 500px">
                ...
                <div class="modal-body">
                    <form id="copy_step_form">
                        <label for="from_step_id" class="col-sm-5 col-form-label"><?php echo $text['copy_from']; ?></label>
                        <div style="padding-left: 10px;">
                            <div class="row mb-3">
                                <label for="from_step_id" class="col-sm-5 col-form-label"><?php echo $text['step_id']; ?>：</label>
                                <div class="col-sm-5">
                                    <input type="number" class="form-control" id="from_step_id" disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="from_step_name" class="col-sm-5 col-form-label"><?php echo $text['step_name']; ?>：</label>
                                <div class="col-sm-5">
                        ...
                        <label for="to_step_id" class="col-sm-5 col-form-label"><?php echo $text['copy_to']; ?></label>
                        <div style="padding-left: 10px;">
                            <div class="row mb-3">
                                <label for="to_step_id" class="col-sm-5 col-form-label"><?php echo $text['step_id']; ?>：</label>
                                <div class="col-sm-5">
                                    <input type="number" class="form-control" id="to_step_id" disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="to_step_name" class="col-sm-5 col-form-label"><?php echo $text['step_name']; ?>：</label>
                                <div class="col-sm-5">
...
<script type="text/javascript">
    ...
    function form_advancedstep_validate(target_type) {   
        ...
        if(target_type == 2){//torque
            ...
            //監控模式會影像hi lo的判斷，等比例就不管hi low torque，上下限就不管Torque_Window_Add、Torque_Window_Subtraction
            if(Monitor_Option == 0){
