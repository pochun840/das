...
<div class="container-ms">
            ...
            <div id="DivMode">
                ...
                <div id="TableInput">
                    <div id="TableInputSetting" align="center">
                        <table id="input_table" class="w3-table-all w3-hoverable w3-large" style=" width: 100%">
                            <thead>
                                <tr style="height:48px; font-size: 16px;" class="w3-dark-grey">
                                    <th class="w3-center" width="20%"><?php echo $text['event']; ?></th>
                                    <th class="w3-center" width="8.8%">2</th>
                                    <th class="w3-center" width="8.8%">3</th>
                                    <th class="w3-center" width="8.8%">4</th>
                                    <th class="w3-center" width="8.8%">5</th>
                                    <th class="w3-center" width="8.8%">6</th>
                                    <th class="w3-center" width="8.8%">7</th>
                                    <th class="w3-center" width="8.8%">8</th>
                                    <th class="w3-center" width="8.8%">9</th>
                                    <th class="w3-center" width="8.8%">10</th>
                                    <th class="w3-center" width="8.8%">Conf</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
                ...
                <div id="TableDataInput">
                    <div id="TableInputData" align="center">
                        <div class="scrollbar" id="style-tableinput">
                            <div class="force-overflow">
                                <table id="detail_table" class="w3-table-all w3-hoverable w3-large">
                                    <thead id="header-table">
                                        <tr style="height:45px; font-size: 16px;" class="w3-dark-grey">
                                            <th class="w3-center" width="8.33%">P</th>
                                            <th class="w3-center" width="8.33%">Mode</th>
                                            <th class="w3-center" width="8.33%">Evt</th>
                                            <th class="w3-center" width="8.33%">2</th>
                                            <th class="w3-center" width="8.33%">3</th>
                                            <th class="w3-center" width="8.33%">4</th>
                                            <th class="w3-center" width="8.33%">5</th>
                                            <th class="w3-center" width="8.33%">6</th>
                                            <th class="w3-center" width="8.33%">7</th>
                                            <th class="w3-center" width="8.33%">8</th>
                                            <th class="w3-center" width="8.33%">9</th>
                                            <th class="w3-center" width="8.33%">10</th>
                                            <th class="w3-center" width="8.8%">Conf</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                    ...
                    <div id="Event_List" align="center">
                        <div class=" w3-panel w3-border-bottom" style="font-size: 20px">Event List</div>
    ...
    <div id="InputNew" class="modal">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="width: 550px; top:15%">
            <header class="w3-container w3-dark-grey" style="height: 48px">
                ...
                <tr>
                    <td colspan="2">
                        <form id="Select_Event" action="#">
                            ...
                            <select id="event_select" style="margin: 0px 0px 20px">
                                ...
                                <?php foreach ($data['job_list'] as $key => $value) {
                                    if($value['job_id'] < 100){
                                    echo "<option value='".$value['job_id']."' >SW Nor-".$value['job_id']." ".$value['job_name']."</option>";
                                    }else{
                                    echo "<option value='".$value['job_id']."' >SW Adv-".$value['job_id']." ".$value['job_name']."</option>";
                                    }
                                }?>
                            </select>
                        </form>
                        ...
                        <tr>
                            <td>
                                ...
                                <input style="zoom:2; margin:2px; vertical-align: middle" id="Input_2_On" name="Input_New" value="2_on" type="radio">
                                <label for="Input_2_On"><img src="../public/img/high.png" width="30" height="30"></label>&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; vertical-align: middle" id="Input_2_Off" name="Input_New" value="2_off" type="radio">
                                <label for="Input_2_Off"><img src="../public/img/low.png" width="30" height="30"></label>
                            </td>
                            <td>
                                <label for="Input7">7 :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; margin:2px; vertical-align: middle" id="Input_7_On" name="Input_New" value="7_on" type="radio">
                                <label for="Input_7_On"><img src="../public/img/high.png" width="30" height="30" alt=""></label>&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; vertical-align: middle" id="Input_7_Off" name="Input_New" value="7_off" type="radio">
                        ...
                        <tr>
                            <td>
                                ...
                                <input style="zoom:2; margin:2px; vertical-align: middle" id="Input_3_On" name="Input_New" value="3_on" type="radio">
                                <label for="Input_3_On"><img src="../public/img/high.png" width="30" height="30"></label>&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; vertical-align: middle" id="Input_3_Off" name="Input_New" value="3_off" type="radio">
                                <label for="Input_3_Off"><img src="../public/img/low.png" width="30" height="30"></label>
                            </td>
                            <td>
                                <label for="Input8">8 :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; margin:2px; vertical-align: middle" id="Input_8_On" name="Input_New" value="8_on" type="radio">
                                <label for="Input_8_On"><img src="../public/img/high.png" width="30" height="30"></label>&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; vertical-align: middle" id="Input_8_Off" name="Input_New" value="8_off" type="radio">
                        ...
                        <tr>
                            <td>
                                ...
                                <input style="zoom:2; margin:2px; vertical-align: middle" id="Input_4_On" name="Input_New" value="4_on" type="radio">
                                <label for="Input_4_On"><img src="../public/img/high.png" width="30" height="30"></label>&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; vertical-align: middle" id="Input_4_Off" name="Input_New" value="4_off" type="radio">
                                <label for="Input_4_Off"><img src="../public/img/low.png" width="30" height="30"></label>
                            </td>
                            <td>
                                <label for="Input9">9 :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; margin:2px; vertical-align: middle" id="Input_9_On" name="Input_New" value="9_on" type="radio">
                                <label for="Input_9_On"><img src="../public/img/high.png" width="30" height="30"></label>&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; vertical-align: middle" id="Input_9_Off" name="Input_New" value="9_off" type="radio">
                        ...
                        <tr>
                            <td>
                                ...
                                <input style="zoom:2; margin:2px; vertical-align: middle" id="Input_5_On" name="Input_New" value="5_on" type="radio">
                                <label for="Input_5_On"><img src="../public/img/high.png" width="30" height="30"></label>&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; vertical-align: middle" id="Input_5_Off" name="Input_New" value="5_off" type="radio">
                                <label for="Input_5_Off"><img src="../public/img/low.png" width="30" height="30"></label>
                            </td>
                            <td>
                                <label for="Input10">10 :</label>&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; margin:2px; vertical-align: middle" id="Input_10_On" name="Input_New" value="10_on" type="radio">
                                <label for="Input_10_On"><img src="../public/img/high.png" width="30" height="30"></label>&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; vertical-align: middle" id="Input_10_Off" name="Input_New" value="10_off" type="radio">
                        ...
                        <tr>
                            <td>
                                ...
                                <input style="zoom:2; margin:2px; vertical-align: middle" id="Input_6_On" name="Input_New" value="6_on" type="radio">
                                <label for="Input_6_On"><img src="../public/img/high.png" width="30" height="30"></label>&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; vertical-align: middle" id="Input_6_Off" name="Input_New" value="6_off" type="radio">
                        ...
                        <tr id="gate_once_check" style="display: none;">
                            <td colspan="2">
                                ...
                                <input style="zoom:2; margin:2px; vertical-align: middle" id="" name="goc" value="0" type="radio" >
                                <label for=""><?php echo $text['NO']; ?></label>&nbsp;&nbsp;&nbsp;
                                <input style="zoom:2; vertical-align: middle" id="" name="goc" value="1" type="radio" checked>
                    ...
                    <div class="container2 w3-light-grey">
                        ...
                        <div class="modal-body">
                            <form id="Copy_form">
                                ...
                                <label for="to_job_id" class="col-sm-5 col-form-label"><?php echo $text['copy_to']; ?></label>
                                <div style="padding-left: 10px;">
                                    <label for="to_job_id" class="col-sm-5 col-form-label"><?php echo $text['job']; ?> :</label> &nbsp;
