            ...
            <div id="TableJobSetting" align="center">
        	    <div class="scrollbar" id="style-job">
                    <div class="force-overflow">
                        <table id="Table_Job" class="w3-table-all w3-hoverable w3-large" style="margin: 0 !important;">
                			...
                			<tbody>
                				<?php
                					foreach ($data['jobs'] as $key => $value) { //job列表
                						...
                						echo "<td class='w3-center'> <img src='..\public\img\btn_plus.png' style=\" border: 2px solid black;cursor: pointer; \" onclick=\"location.href = '?url=Sequences/index/".$value['job_id']."';\"> </td>";
                						echo '</tr>';
                					}
                				?>
                			</tbody>
    ...
    <div class="footer">
        <div id="TotalPage">
            <table id="TotalJobTable">
                <tr>
                    <td style="color:black; float: left"><?php echo $text['total_job']; ?> : <input style="text-align: center" id="RecordCnt" name="RecordCnt" readonly="readonly" disabled size="4" maxlength="3" value=""> </td>
                    <!--
                    <td width="50%" align="right" style="color:black">
                  	<?php echo $text['page']; ?> : <input style="text-align: center" id="CurrentPage" name="CurrentPage" readonly="readonly" size="3" maxlength="3" value="">
                   	<?php echo $text['page_of']; ?> <input style="text-align: center" id="TotalPage2" name="TotalPage" readonly="readonly" size="3" maxlength="3" value=""> </td>
                    <td>
    	  ...
    	  <div class="modal-dialog modal-dialog-centered modal-lg">
    	    <div class="modal-content w3-animate-zoom" style="width: 650px">
    	      ...
    	      <div class="modal-header">
    	        ...
    	        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="color: #FF3300;"></button>
    	      </div>
    	      ...
    	      <div class="modal-body">
    	        <form id="new_job_form">
    	          <div class="row mb-3">
    			    <label for="job_id" class="col-sm-5 col-form-label"><?php echo $text['job_id']; ?>：</label>
    			    <div class="col-sm-4">
    			  ...
    			  <div class="row mb-3">
    			    <label for="job_name" class="col-sm-5 col-form-label"><?php echo $text['job_name']; ?>：</label>
    			    <div class="col-sm-4">
    			  ...
    			  <div class="row mb-6">
    			    <legend for="ok_job" class="col-sm-5 col-form-label pt-0"><?php echo $text['job_ok']; ?>：</legend>
    			    <div class="row col-sm-7" style=" margin-left: 0; ">
    			    	<div class="form-check form-check-inline col-sm-3">
    					  <input class="form-check-input" type="radio" name="ok_job_option" id="ok_job_off" value="0">
    					  <label class="form-check-label" for="ok_job_off"><?php echo $text['switch_off']; ?></label>
    					</div>
    			      	<div class="form-check form-check-inline col-sm-3">
    					  <input class="form-check-input" type="radio" name="ok_job_option" id="ok_job_on" value="1">
    					  <label class="form-check-label" for="ok_job_on"><?php echo $text['switch_on']; ?></label>
    					</div>
    			    </div>
    			  </div>
    			  <div class="row mb-6">
    			    <label  class="col-sm-5 col-form-label pt-0"><?php echo $text['job_ok_stop']; ?>：</label>
    			    <div id="div_ok_job_stop" class="row col-sm-7" style=" margin-left: 0; ">
    			      	<div class="form-check form-check-inline col-sm-3">
    					  <input class="form-check-input" type="radio" name="ok_job_stop_option" id="ok_job_stop_off" value="0">
    					  <label class="form-check-label" for="ok_job_stop_off"><?php echo $text['switch_off']; ?></label>
    					</div>
    			      	<div class="form-check form-check-inline col-sm-3">
    					  <input class="form-check-input" type="radio" name="ok_job_stop_option" id="ok_job_stop_on" value="1">
    					  <label class="form-check-label" for="ok_job_stop_on"><?php echo $text['switch_on']; ?></label>
    					</div>
    			    </div>
    			  </div>
    			  <div class="row mb-8">
    			    <label  class="col-sm-5 col-form-label pt-0"><?php echo $text['unfasten_direction']; ?>：</label>
    			    <div class="row col-sm-7" style=" margin-left: 0; ">
    					...
    					<div class="form-check form-check-inline col-sm-3">
    					  <input class="form-check-input" type="radio" name="unfasten_direction_option" id="unfasten_direction_disable" value="2">
    					  <label class="form-check-label" for="unfasten_direction_disable"><?php echo $text['disable']; ?></label>
    					</div>
    			    </div>
    			  </div>
    			  <div class="row mb-8">
    			    <label for="unfasten_RPM" class="col-sm-5 col-form-label"><?php echo $text['unfasten_rpm']; ?>：</label>
    			    <div class="col-sm-3">
    			  ...
    			  <div class="row mb-3  pt-3">
    			    <label for="unfasten_force" class="col-sm-5 col-form-label"><?php echo $text['unfasten_force']; ?>(%)</label>
    			    <div class="col-sm-4">
    			  ...
    			  <div class="row mb-6">
    			    <label  class="col-sm-5 col-form-label pt-0"><?php echo $text['rev_count']; ?></label>
    			    <div class="row col-sm-7" style=" margin-left: 0; ">
    			      	<div class="form-check form-check-inline col-sm-3">
    					  <input class="form-check-input" type="radio" name="reverse_cnt_mode_option" id="reverse_cnt_mode_off" value="0">
    					  <label class="form-check-label" for="reverse_cnt_mode_off"><?php echo $text['switch_off']; ?></label>
    					</div>
    			      	<div class="form-check form-check-inline col-sm-3">
    					  <input class="form-check-input" type="radio" name="reverse_cnt_mode_option" id="reverse_cnt_mode_on" value="1">
    					  <label class="form-check-label" for="reverse_cnt_mode_on"><?php echo $text['switch_on']; ?></label>
    					</div>
    			    </div>
    			  </div>
    			  <div class="row mb-3  pt-3">
    			    <label for="reverse_threshold_torque" class="col-sm-5 col-form-label"><?php echo $text['rev_tor_threshold']; ?></label>
    			    <div class="col-sm-3">
    			      <input type="number" class="form-control" id="reverse_threshold_torque" oninput="validateInput_unfasten_threshold('reverse_threshold_torque')">
    			    </div>
    			    <div class="col-sm-4 pt-1">
        			    <label><?php echo $text['unit_status_'.$data['controller_Info']['device_torque_unit'].'']; ?></label>
                    </div>
    			  </div>
    			</form>
    	      </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
        	    <div class="modal-content w3-animate-zoom" style="width: 600px">
        	        ...
        	        <div class="modal-body">
        			    ...
        			    <div style="padding-left: 10px;">
        				    <div class="row mb-3">
        				        <label for="to_job_id" class="col-sm-5 col-form-label"><?php echo $text['job_id']; ?>：</label>
        				        <div class="col-sm-5">
        				    ...
        				    <div class="row mb-3">
        				        <label for="to_job_name" class="col-sm-5 col-form-label"><?php echo $text['job_name']; ?>：</label>
        				        <div class="col-sm-5">
